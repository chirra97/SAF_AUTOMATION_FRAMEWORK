...
public class ElementActions {
	...
	public void addStepsToResults(STATUS stepStatus, STATUS requiredScreenShot, String stepName, String stepDetails) {

		switch (requiredScreenShot) {
		case YES:
			if ("PASS".contentEquals(stepStatus.toString())) {
				htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, stepStatus.toString(), stepName,
						stepDetails);
				log4jObj.info(stepDetails);
			} else if ("FAIL".contentEquals(stepStatus.toString())) {
				htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, stepStatus.toString(), stepName,
						stepDetails);
				log4jObj.error(stepDetails);
			} else if ("INFO".contentEquals(stepStatus.toString())) {
				htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, stepStatus.toString(), stepName,
						stepDetails);
				log4jObj.info(stepDetails);
			}
		...
		case NO:
			if ("PASS".contentEquals(stepStatus.toString())) {
				htmlReportObj.addTestStepToReport(reportTCObject, stepStatus.toString(), stepName, stepDetails);
				log4jObj.info(stepDetails);
			} else if ("FAIL".contentEquals(stepStatus.toString())) {
				htmlReportObj.addTestStepToReport(reportTCObject, stepStatus.toString(), stepName, stepDetails);
				log4jObj.error(stepDetails);
	...
	public boolean enterText(By elementLocater, String testDataColumnName, String elementName) {
		...
		try {
			...
			addStepsToResults(STATUS.PASS, STATUS.YES, step, passStep);
			return true;
		} catch (Exception e) {
			String failStep = "Unable to enter Text " + testData + " entered into " + elementName;
			addStepsToResults(STATUS.FAIL, STATUS.YES, step, failStep + "\n" + e.getMessage());
			return false;
		}
	}
	...
	public void clickElement(By elementLocater, String elementName) {
		...
		try {
			...
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "PASS",
					"Click on " + elementName + " element", "Unable to click on " + elementName + " element");
		} catch (Exception e) {
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "FAIL",
					"Click on " + elementName + " element", "Unable to click on " + elementName + " element");
			e.printStackTrace();
	...
	public void acceptAlert(By elementLocater, String elementName) {
		...
		try {
			...
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "PASS", "Accept alert",
					"Alert accpeted");
		} catch (Exception e) {
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "FAIL", "Accept alert",
					"Unable to acept Alert");
			e.printStackTrace();
		}
	}
	...
	public void dismissAlert(By elementLocater, String elementName) {
		...
		try {
			...
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "PASS", "Dismiss alert",
					"Dismiss accpeted");
		} catch (Exception e) {
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "FAIL", "Dismiss alert",
	...
	public String getAlertMessage(By elementLocater, String elementName) {
		...
		try {
			...
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "PASS", "Capture alert message",
					"Alert having message " + alertMessage);
		} catch (Exception e) {
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "FAIL", "Capture alert message",
	...
	public void switchToLatestWindow() {
		...
		try {
			...
			driver.switchTo().window(windowId);
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "PASS", "Switch to latest window",
					"Swiched to latest window successfully");
		} catch (Exception e) {
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "FAIL", "Switch to latest window",
	...
	public void switchToMainWindow() {
		...
		try {
			...
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "PASS", "Switch to main window",
					"Swiched to main window successfully");
		} catch (Exception e) {
			htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "FAIL", "Switch to main window",
