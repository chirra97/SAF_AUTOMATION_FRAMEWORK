...
public class DriverSetup {
	...
	@BeforeClass
	public void loadClassTestDataAndHtmlAndLogReportInitiation(String CLASSNAME, String TC_ID, String BROWSER) throws Exception {
		...
		String documnetFilePath =  FW_Constants.htmlReport_resultsFolderPath + "/" + TC_ID + "_"
		...
		String logFilePath = FW_Constants.htmlReport_resultsFolderPath + "/" + TC_ID + "_"
	...
	private void driverSetup(String driverType, String browser, String TC_ID,
			LinkedHashMap<String, String> classTestData_LHM, HTMLReport htmlReportObj, WordGenerator wordDocGenerateObj, Logger log4jObj) {
		...
		if (driverType.equalsIgnoreCase("Web Driver")) {
			if (browser.equalsIgnoreCase("Chrome")) {
				...
				htmlReportObj.addTestStepToReportWithScreenShot(driver, reportTCObject, wordDocGenerateObj, "PASS", TC_ID, TC_ID);
				log4jObj.info("******************************************************************************");
	 ...
	 */
	private WebDriver launchChromeBrowser(String appURL) {
